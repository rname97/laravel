<div class="card">
    <div class="card-body">
        <form>
            ...
            <div class="form-group mb-3">
                <label for="kategori_id">Title:</label>
                <input type="text" class="form-control @error('kategori_id') is-invalid @enderror" id="kategori_id"
                       placeholder="Enter kategori_id" wire:model="kategori_id">
                @error('kategori_id')
                <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
